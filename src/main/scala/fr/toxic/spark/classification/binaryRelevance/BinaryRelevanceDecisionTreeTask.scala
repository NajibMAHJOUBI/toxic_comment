...
/**
  ...
  */
class BinaryRelevanceDecisionTreeTask(val data: DataFrame,
  ...
  def computeModel(data: DataFrame, column: String): DecisionTreeClassificationModel = {
  ...
  def computePrediction(data: DataFrame, model: DecisionTreeClassificationModel): DataFrame = {
